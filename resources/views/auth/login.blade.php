          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  <div class="logo">
                    <h1><center><img src="{{ asset('dist/unram.png') }}" width="300"></center></h1>
                  </div>
                  <p><center><font color="#FFD700" size="4">Aplikasi Penginputan Nilai SMA Negeri 1 Tanjung</font></center></p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><br><a href="/" class="signup">< Kembali ke beranda</a>
                </div>
              </div>
            </div>
          </div>
