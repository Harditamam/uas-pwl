...
@section('judul','Edit Akun Pimpinan Fakultas')
@section('konten')
<div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" method="post" action="/admin/update_akun_fakultas/{{ $users->id }}">
                      @csrf
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nip" placeholder="NIP" autocomplete="off" class="form-control @error('nip') is-invalid @enderror" value="{{ $users->nip }}">
                            @error('nip')
                          <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="jabatan" placeholder="Jabatan" autocomplete="off" class="form-control @error('jabatan') is-invalid @enderror" value="{{ $users->jabatan }}">
                          </div>
                        </div>
                        <div class="form-group">
