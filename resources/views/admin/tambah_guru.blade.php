...
<div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" method="post" action="/admin/store_guru">
                      @csrf
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="no_hp" placeholder="No HP" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp') }}">
                            @error('no_hp')
                          <div class="invalid-feedback">
                              {{ $message }}
                            </div>
