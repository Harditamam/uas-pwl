...
<div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" method="post" action="/admin/store_operator">
                        @csrf
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nis" placeholder="NIS" autocomplete="off" class="form-control @error('nis') is-invalid @enderror">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-3 form-control-label">Kelas</label>
                          <div class="col-sm-9">
                            <input type="text" name="kelas" placeholder="Kelas" autocomplete="off" class="form-control @error('kelas') is-invalid @enderror" value="{{ old('kelas') }}">
                            @error('kelas')
                          <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="phone" placeholder="No. Handphone" class="form-control">
