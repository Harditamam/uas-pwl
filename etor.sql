...
INSERT INTO `gurus` (`id`, `nama`, `email`, `no_hp`, `created_at`, `updated_at`) VALUES
(1, 'eko1', 'eko@gmail.com', '1212212', '2025-01-14 05:43:37', '2025-01-14 05:54:47');
...
--
-- Table structure for table `kodemak`
--
...
--
-- Table structure for table `kodemakrincian`
--
...
(1, 'Fisika 1', '2025-01-14 06:15:55', '2025-01-14 06:19:59');
...
(24, '2021_09_07_025030_create_iku_table', 6),
(25, '2021_09_07_165802_create_table_kegiatan', 6),
(26, '2021_09_07_165948_create_table_ikk', 6),
(27, '2021_09_08_132242_create_table_io', 6),
(28, '2021_09_09_061503_create_detail_belanja', 6),
(29, '2021_09_09_095730_create_jadwal', 6),
(30, '2021_09_22_124223_create_catatan_table', 6),
(31, '2021_10_05_151734_create_kodemak_table', 6),
(32, '2021_10_05_152147_create_kodemakrincian_table', 6),
(33, '2025_01_14_115358_add_nis_to_users_table', 7),
(34, '2025_01_14_115741_add_kelas_to_users_table', 8),
(35, '2025_01_14_115941_add_kelas_to_users_table', 9),
(36, '2025_01_14_121125_create_gurus_table', 10),
(37, '2025_01_14_121151_create_mapels_table', 10),
(38, '2025_01_14_121208_create_nilais_table', 10);
...
INSERT INTO `nilais` (`id`, `nilai`, `guru_id`, `mapel_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, '99', 1, 1, 20, '2025-01-14 07:04:40', '2025-01-14 07:26:00');
...
CREATE TABLE `program1` (
  `kode_program1` varchar(255) NOT NULL,
...
CREATE TABLE `program2` (
  ...
  `kode_program2` varchar(255) NOT NULL,
...
--
-- Table structure for table `program3`
--

CREATE TABLE `program3` (
  `id_program3` bigint(20) UNSIGNED NOT NULL,
  `kode_program3` varchar(255) NOT NULL,
...
--
-- Dumping data for table `program3`
--
...
--
-- Table structure for table `table_ikk`
--

CREATE TABLE `table_ikk` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ikk` varchar(255) NOT NULL,
...
--
-- Table structure for table `table_io`
--
...
--
-- Table structure for table `tbikk`
--

CREATE TABLE `tbikk` (
  `kode_ikk` varchar(255) NOT NULL,
  `judul_ikk` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tbikk`
--
...
--
-- Table structure for table `tbikkuraian`
--

CREATE TABLE `tbikkuraian` (
  `id_ikk_uraian` bigint(20) UNSIGNED NOT NULL,
  `kode_ikk_uraian` varchar(255) NOT NULL,
  `kode_ikk` varchar(255) NOT NULL,
  `judul_ikk_uraian` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tbikkuraian`
--
...
--
-- Table structure for table `tbikupilar`
--
...
--
-- Dumping data for table `tbikupilar`
--
...
--
-- Table structure for table `tbl_etor`
--
...
CREATE TABLE `tbl_etor` (
  ...
  `no_tor` text NOT NULL,
  `latar_belakang` text NOT NULL,
  `rasional` text NOT NULL,
  `tujuan` text NOT NULL,
  `oke` varchar(30) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tb_jenjang` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `code_unit` varchar(255) NOT NULL,
  `code_jenjang` varchar(255) NOT NULL,
...
CREATE TABLE `tb_uraian` (
  ...
  `code_jenjang` varchar(20) NOT NULL,
  `code_uraian` varchar(20) NOT NULL,
  `uraian` varchar(255) NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `nis`, `kelas`) VALUES
(1, 'Hardi', 'a@mail.com', NULL, 'admin', NULL, '$2a$12$Jnjqe92F2FaUDutHTiDLpOREVlxgDs./lRXNnJEb312h8d.Wr.cGC', NULL, '2021-07-01 22:48:43', '2025-01-14 05:06:44', '', ''),
(20, 'Eko Efri', 'bd@mail.com', '0928838838', 'siswa', NULL, '$2a$12$Jnjqe92F2FaUDutHTiDLpOREVlxgDs./lRXNnJEb312h8d.Wr.cGC', NULL, '2021-07-07 03:50:56', '2025-01-14 07:06:17', '123', '1'),
(27, 'Eka Martha', 'ekoefriwartanto28@gmail.com', NULL, 'admin', NULL, '$2y$10$dfhuNTuaf6PVSoOPoaXNYurEvUzpKYZMEaWVUXdJ3CQ9.1APtmRYC', NULL, '2025-01-14 03:52:45', '2025-01-14 03:55:20', '', ''),
(29, 'eko123', 'ekosukses28@gmail.com', NULL, 'admin', NULL, '$2y$10$htVKEFl1vk9QDj78OTKzB.cjay3tDYY2ARb0kIbN40hO5oChzdsQq', NULL, '2025-01-14 04:25:21', '2025-01-14 04:25:21', '', ''),
(35, 'akun', 'akun@mail.com', 'akun', 'siswa', NULL, '$2y$10$86sJXQ1dVPLhUqsdmDwpX.57jlvkrEB4PMjqRI5FQnQUbk3gTFYdW', NULL, '2025-01-14 04:43:44', '2025-01-14 04:43:44', '', '');
...
--
-- Indexes for table `kodemakrincian`
--
...
--
-- AUTO_INCREMENT for table `kodemakrincian`
--
ALTER TABLE `kodemakrincian`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
